...
import { getAllBlogs, getBlogsByTags } from "../../../redux/actions/blogs";
...
const BlogList = ({ blogs: { blogs, total }, getAllBlogs, getBlogsByTags, history, location }) => {
  ...
  useEffect(() => {
    async function getData(){
      setIsLoading(true);
      tags ? await getBlogsByTags(tags, page) : await getAllBlogs(page);
      setIsLoading(false);
    }
    getData();
  }, [getAllBlogs, getBlogsByTags, tags, page]);
...
export default connect(mapStateToProps, { getAllBlogs, getBlogsByTags })(BlogList);
