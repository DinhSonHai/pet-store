...
import { FastBackwardOutlined, SyncOutlined } from '@ant-design/icons';
...
const OrderTracking = ({ id, setView, setId, setOrder, getOrderById }) => {
...
export default connect(null, { getOrderById })(OrderTracking);
