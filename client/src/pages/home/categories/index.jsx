    ...
    <section className='category'>
      <div className='category__wrap container'>
        ...
        <div className='category__content'>
          <Row
            gutter={[
              { xs: 12, sm: 16, md: 16, lg: 26 },
              { xs: 12, sm: 16, md: 16, lg: 26 },
            ]}
          >
            <Col xs={12} sm={12} md={8} lg={6}>
              <Link to={`/products/dog/5f9d1f0f92c1c0b400863677`}>
                <Card
                  bordered={false}
                  cover={
            ...
            <Col xs={12} sm={12} md={8} lg={6}>
              <Link to={`/products/cat/5f9d1f1d92c1c0b400863843`}>
                {' '}
                <Card
                  bordered={false}
                  cover={
            ...
            <Col xs={12} sm={12} md={8} lg={6}>
              <Link to={`/products/food/5ff00f72488a9a35bcb5d1dc`}>
                {' '}
                <Card
                  bordered={false}
                  cover={
            ...
            <Col xs={12} sm={12} md={8} lg={6}>
              <Link to={`/products/accessories/5ff01f04d5b5e035d8ed9f67`}>
                {' '}
                <Card
                  bordered={false}
                  cover={
