...
import { Card, Form, Input, Select, DatePicker, Button, Checkbox } from 'antd';
...
const { Option } = Select;
const ProfileInfo = ({ auth: { user }, updateUserInfo }) => {
    ...
    if (selected && types.includes(selected.type)) {
      ...
      if (parseInt(file_size) > 2097152) {
        return notifyActions(
          'error',
          'Ảnh đại diện có dung lượng phải bé hơn 2mb'
        );
      }
      const options = {
        maxSizeMB: 2,
...
export default connect(mapStateToProps, { updateUserInfo })(ProfileInfo);
